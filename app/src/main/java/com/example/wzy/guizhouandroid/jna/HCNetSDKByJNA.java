package com.example.wzy.guizhouandroid.jna;
...
public interface HCNetSDKByJNA extends Library {
    ...
    public static class NET_DVR_SCENE_INFO  extends Structure {
           ...
           public NET_DVR_PTZPOS  struPtzPos = new NET_DVR_PTZPOS();             //Ptz 坐标
	...
	public static class NET_DVR_DIRECTION extends Structure {
		...
		public NET_DVR_PTZPOS  struStartPoint = new NET_DVR_PTZPOS();             // 方向起始点
		public NET_DVR_PTZPOS  struEndPoint = new NET_DVR_PTZPOS();             // 方向结束点
		@Override
		protected List<String> getFieldOrder() {
			// TODO Auto-generated method stub
